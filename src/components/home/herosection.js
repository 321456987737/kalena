    ...
    <section className="w-full  bg-[#FEFEFE] flex items-center justify-center px-6 ">
      <div className="max-w-8xl w-full h-full  grid md:grid-cols-2 gap-12 items-center">
        ...
        >
         <div className="flex flex-col gap-6">
          ...
          <h1 className="text-4xl md:text-5xl Merriweather font-bold leading-tight text-[#2D1F1A]">
            Awaken Your Senses With a <br  /><span className="text-[#F5977E]">
                Perfect Cup of Coffee
            </span>
          </h1>

          <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-xl">
            Experience the aroma of freshly brewed coffee crafted with passion.
            From rich espresso to smooth lattes — every sip tells a story of
            quality and comfort.
          </p>
        ...
        <div className=" md:h-[90vh] h-[50vh] flex items-center justify-center  w-full">
            <div className=" gap-3 md:max-h-[550px] md:max-w-[560px] max-h-[400px] w-[90%]  grid grid-cols-2 grid-rows-2 h-full ">
               <motion.div
          ...
          viewport={{once:true}} className="relative"> <Image
                src={`/gallery/2.jpg`}
                alt="coffee"
                width={500}
                height={500}
