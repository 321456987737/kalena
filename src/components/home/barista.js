...
export default function HeightScaleCarouselAlt({ slides }) {
  ...
  return (
    ...
    <div className="md:min-h-screen h-[90vh]  my-8 w-full  flex flex-col items-center justify-center">
      <div className=" w-full items-center flex  justify-center flex-col text-center px-3 ">
        <motion.h2
          ...
          className="text-3xl md:text-4xl Merriweather max-w-125 font-semibold mt-3 Merriweather leading-tight"
        >
          The People Behind 
          <span className="text-[#F5977E]">
            Your Perfect Cup
            </span>
        </motion.h2>
              ...
              <div className="embla__slide " key={index}>
                <div className="heightWrapper  relative">
                  ...
                  <div className=" bg-[#F9F7F5] absolute bottom-0 rounded-tr-2xl rounded-tl-2xl">
                    <div className="content text-center px-2 Merriweather ">
                      {slide.name}
                    </div>
                    <div className="content text-center px-2 Merriweather">
                      {slide.role}
